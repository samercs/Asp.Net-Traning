...
namespace Lesson9.Controllers
{
    public class ProductsTestController : Controller
    {
        ...
        public ProductsTestController(AppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,IsDeleted,DeletedAt")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,IsDeleted,DeletedAt")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
